...
public class Test_Non_Gov_For_Demo extends Base

{
	...
	// Done
		...
		public void E2E_Test_Non_Gov_100_Lumpsum(Map<String , String >data) 
		{
			...
			w.non_government_lumpsum_100_0_DC(data.get("User_ID") ,data.get("Password"),data.get("PRAN") ,data.get("DOD"),data.get("PAO_AIN") ,data.get("Marritualstatus"), data.get("spousestatus") );
	    ...
	    public void testverify_No_Annuitant_(Map<String, String >data) throws InterruptedException
	    {
	      ...
	      VA.Verify_and_Authorize_Non_Government_DC(data.get("UID"),data.get("Pass2") , data.get("PRAN"));
	    }
